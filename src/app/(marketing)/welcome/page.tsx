      ...
      {upgraded && (
        <div style={{ ...S.card, borderLeft: "3px solid #2E8E3A", marginBottom: 16 }}>
          ...
          <p style={{ fontSize: 13.5, color: "#56627A", lineHeight: 1.55, margin: 0, textAlign: "left" }}>
            Your subscription is active. Your billing portal is in <Link href="/settings" style={{ color: "#28C55E" }}>Settings → Billing</Link>. Receipt was emailed to {user?.primaryEmailAddress?.emailAddress ?? "your inbox"}.
          </p>
        </div>
      )}
