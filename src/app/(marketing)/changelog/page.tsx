            ...
            >
              ...
              <div style={{ paddingTop: 4, display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 6, position: "relative" }}>
                <span
                  style={{
                    ...
                    background: entry.latest ? "#1E66C9" : "#0B1A2F",
                    color: "#FFFFFF",
                    fontSize: 11,
                    fontWeight: 800,
              ...
              <div
                style={{
                  ...
                  borderLeft: `3px solid ${entry.latest ? "#1E66C9" : "#C6CDDA"}`,
                  borderRadius: 8,
                  padding: "20px 24px",
              ...
              >
                <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12 }}>
                  {entry.items.map((item, j) => (
                    ...
                    >
                      <span
                        style={{ width: 6, height: 6, borderRadius: "50%", background: entry.latest ? "#1E66C9" : "#8A93A5", flexShrink: 0, marginTop: 8, display: "inline-block" }}
                      />
                      <span>{item}</span>
                    </li>
                  ))}
