  ...
  return (
    <div style={S.page}>
      ...
      <p style={S.p}>
        ...
        <Link href="/privacy" style={{ color: "#1E66C9" }}>Privacy Policy</Link>, after
      ...
      <p style={S.p}>
        Legal enquiries: <a href="mailto:legal@proculink.com" style={{ color: "#1E66C9" }}>legal@proculink.com</a>
        <br />
      ...
      <p style={{ ...S.p, marginTop: 40, paddingTop: 24, borderTop: "1px solid #E2E6EE" }}>
        ...
        <Link href="/security" style={{ color: "#1E66C9", marginRight: 16 }}>Security</Link>
