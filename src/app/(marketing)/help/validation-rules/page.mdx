...
- **Connection testing** — a connection revision's test pack includes a conformance check, and replay shows which validation results would flip between pass and fail under a draft revision before you publish ([supplier connections](/help/connections)).
