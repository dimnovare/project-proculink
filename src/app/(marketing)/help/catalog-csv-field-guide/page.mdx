...
> This article is the column reference. To load a catalog for the first time follow [import a supplier catalog from a file](/help/guides/import-a-supplier-catalog), or [keep a catalog in sync automatically](/help/guides/keep-a-catalog-in-sync) to stop doing it by hand.
