...
export const metadata = helpArticleMetadata({
  ...
  description: "What lands in Exceptions, what Resolve and Ignore really do, how delivery retries and out-of-retries orders work, and when to check system health.",
});
...
- **Out of retries** (critical) — automatic delivery retries are exhausted.
