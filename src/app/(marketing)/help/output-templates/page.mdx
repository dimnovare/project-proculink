...
import { STANDARDS_FIELD_COVERAGE } from "@/lib/standards/catalog";
...
| CSV | Supported |
| JSON | Supported |
| cXML 1.2 | Supported — {requiresPlan("cxml")} |
