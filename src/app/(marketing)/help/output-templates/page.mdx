...
> This article is the reference for formats and the templates page. For choosing the format a supplier actually receives, follow [set up delivery to a supplier and test-fire it](/help/guides/set-up-supplier-delivery).
...
## The templates page (Rules & formats → Output templates)
