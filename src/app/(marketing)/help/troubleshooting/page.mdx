...
> This article is the reference for parse failures. If you are getting a first order through end to end, follow [take your first order from upload to delivered](/help/guides/first-order-end-to-end).
