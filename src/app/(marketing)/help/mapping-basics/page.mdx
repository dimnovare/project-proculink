...
> This article is the reference for fields and manipulators. To shape the document one supplier receives, step by step, follow [map a supplier's purchase-order fields](/help/guides/map-supplier-po-fields).
