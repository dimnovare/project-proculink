...
> This article compares the options. When you have chosen one, the step-by-step guides set it up: [receive orders by email](/help/guides/receive-orders-by-email) is written; the API and folder-polling guides are listed in the [guide library](/help/guides).
