...
| **PO Mapping** | Maps the columns of this supplier's order files to ProcuLink's canonical fields. It works from a real sample, so upload an order for this supplier first. |
