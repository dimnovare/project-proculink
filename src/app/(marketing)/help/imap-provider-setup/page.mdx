...
> This article is the per-provider reference. For the whole set-up in order — hosted address first, IMAP only if you need it — follow the guide [receive orders by email](/help/guides/receive-orders-by-email).
