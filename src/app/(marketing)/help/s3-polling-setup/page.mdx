...
> This article is the reference for the individual settings. For the set-up in order, follow [pull order files from S3 or Cloudflare R2](/help/guides/receive-orders-from-s3).
